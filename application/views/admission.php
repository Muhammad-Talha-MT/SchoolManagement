							...
							<form method="POST" enctype="multipart/form-data" action="<?php echo base_url() . 'Student/addStudent' ?>" class="needs-validation">
								<div class="form-row">
									...
									<div class="form-group col-md-4">
										<img style="max-width: 180px; border-radius: 5px; margin: 35px 0px 10px 70px;" id="blah" src="<?php echo base_url() . 'upload/download.png'; ?>" alt="your image" />
										<input style="max-width: 180px; border-radius: 5px; max-height: 50px; margin-left: 70px; padding-left: 35px" id="uploadPicture" type="file" name="uploadPicture" onchange="readURL(this);" style="margin-left: 50px" required>
									</div>
								</div>
								...
								<div class="form-row">
									<div class="form-group col-md-4">
										...
										<input class="form-control" type="text" name="cellNumber" minlength="11" maxlength="11" id="cellNumber" placeholder="03000000000" required>
									</div>
									<div class="form-group col-md-4">
